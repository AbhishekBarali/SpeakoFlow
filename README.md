...
### 👁️ Screen vision
- Press **Ctrl + Alt + Shift + Space** — or just *say* "what's on my screen?" — and the assistant sees a screenshot of your active monitor
- The camera button in the panel arms a screenshot for your next message (typed *or* spoken)
...
2. Open **Settings → Assistant**:
   - Pick a provider (e.g. *Custom* for Azure OpenAI, *Local* for Ollama)
...
- **Assistant questions + optional screenshots**: sent only to the LLM provider *you* configure (which can itself be local)
