...
**A free, local-first voice assistant for your desktop — dictation, writing, and a real AI assistant, all by voice.**
...
[**Download**](https://github.com/AbhishekBarali/SpeakoFlow/releases) &nbsp;·&nbsp; [**Website**](https://www.speakoflow.com) &nbsp;·&nbsp; [**Discussions**](https://github.com/AbhishekBarali/SpeakoFlow/discussions) &nbsp;·&nbsp; [**Issues**](https://github.com/AbhishekBarali/SpeakoFlow/issues)
...
- [Features](#features)
  - [Dictation (local & offline)](#dictation-local--offline)
...
SpeakoFlow turns your voice into finished text, right where you're working — email, editor, chat, anywhere. Press a key and talk, and your words are typed into whatever app has focus. Say **"Hey Flow"** first and it goes further: it drafts the reply, writes the email, or answers the question and pastes the result for you. And when you need a back-and-forth, a floating AI assistant is a hotkey away — it can talk back, read your screen, search the web, and remember how you like to work.
...
- **Free.** No subscription, no account, no usage caps.
- **More than dictation.** Generate with Flow, AI cleanup, a chat assistant that talks back, and screen vision — not just transcription.
- **Your models, your rules.** A built-in offline LLM, your own local server, or any provider you plug in with your own key.
- **Cross-platform.** Windows, macOS, and Linux.

## Features

### Dictation (local & offline)
...
- **Voice commands** — trigger actions and complete tasks hands-free, just by saying what you want
...
SpeakoFlow is built on [**Handy**](https://github.com/cjpais/Handy) by **CJ Pais** and its contributors. The local dictation core — the Whisper/Parakeet pipeline, voice activity detection, the recording overlay, and the settings architecture — is their excellent work, and SpeakoFlow keeps it under the same MIT license. Genuine thanks to them for building it in the open.

Also built on the shoulders of many open-source projects: [Tauri](https://tauri.app), whisper.cpp / whisper-rs, llama.cpp, Silero VAD, [Kokoro](https://github.com/hexgrad/kokoro), and the wider Rust and React ecosystems.
