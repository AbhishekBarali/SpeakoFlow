...
description: "Fixes for the most common SpeakoFlow problems: the macOS damaged-app message, blocked microphone or accessibility permissions, text that will not type, Linux hotkey permissions and the floating overlay, and clipped or wrong pastes."
icon: "life-ring"
---
...
<Accordion title="Nothing gets typed after I dictate (macOS)" icon="keyboard">
  SpeakoFlow needs Accessibility permission to type into other apps. Grant it in
...
<Accordion title="Screen vision does nothing (macOS)" icon="eye-slash">
  ...
  Screen Recording*, then restart SpeakoFlow for it to take effect.
</Accordion>
