...
description: "Streaming models show your words in SpeakoFlow's overlay while you speak, but text is still inserted once after you stop. This page lists which transcription models stream and how the overlay style switches streaming on and off."
...
There is no separate live transcription switch. It follows the overlay style in _Settings → General → Overlay_.
