...
| ----------------- | ----------------------------------------------------------- | ---------------------------------------------- |
| Text replacements | _Settings → Dictation → Output options → Text replacements_ | Swaps a phrase you say for text you use often. |
| Spoken emoji      | _Settings → Dictation → Output options → Spoken emoji_      | Turns "thumbs up emoji" into 👍.               |
