...
<ResponseField name="Provider" type="OpenAI | Anthropic | Azure | OpenRouter | Custom | Local">
  The provider that answers assistant questions.
</ResponseField>

<ResponseField name="Base URL" type="url">
...
<ResponseField name="Context window" type="number" default="8192">
...
<ResponseField name="Unload from memory after" type="duration">
