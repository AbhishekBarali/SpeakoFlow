...
<ResponseField name="Screen access" type="Off | Manual | Agent decides" default="Off">
...
<ResponseField name="When to capture" type="When I ask | When the message sends" default="When I ask">
