...
<ResponseField name="Speak responses aloud" type="toggle" default="off">
  Read the assistant's replies out loud.
</ResponseField>

<ResponseField name="Stop speech when dictation starts" type="toggle">
...
<ResponseField name="Kokoro precision" type="fp32 | q8">
  **fp32** is highest quality; **q8** is faster on CPU. Changing this reloads the model.
</ResponseField>

<ResponseField name="Playback speed" type="number" default="1×">
  Adjust faster or slower to taste. ElevenLabs supports 0.7×–1.2× only.
</ResponseField>

<ResponseField name="Test voice" type="action">
