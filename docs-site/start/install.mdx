...
Download SpeakoFlow for your operating system from the [Releases page](https://github.com/AbhishekBarali/SpeakoFlow/releases), then follow the tab for your platform.
