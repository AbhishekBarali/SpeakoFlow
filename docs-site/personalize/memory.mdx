...
<ResponseField name="Remember me" type="toggle" default="off">
  Let the assistant keep and use a personal memory.
</ResponseField>

<ResponseField name="Incognito chat" type="toggle">
  For the current conversation, don't use memory and don't learn anything new.
</ResponseField>

<ResponseField name="Memory detail" type="Light | Balanced | Detailed">
