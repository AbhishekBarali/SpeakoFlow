...
- Saying "what's on my screen", "look at this error", etc. auto-attaches a capture on the *normal* hotkey
- Camera button in the panel arms a one-shot screenshot for the next message — typed *or* spoken
...
- Round 2: budgeted the *encoded* size ≤96 KB → still failed at smaller positions
