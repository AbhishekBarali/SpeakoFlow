...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_post_process_cleanup_strength_setting,
            ...
            commands::agents::agent_available_agents,
            commands::agents::agent_session_interrupt_with,
            commands::agents::agent_session_set_mode,
            commands::agents::agent_session_modes,
            commands::agents::agent_session_set_auto_approve,
            commands::agents::agent_create_project_folder,
